import { addMessages } from 'c/alfaActions';
import {
  isEmpty,
  hasElements,
  reduxSagaPut,
...
export function* showMessage(message) {
  ...
  if (hasElements(msg.successes) || hasElements(msg.infos) || hasElements(msg.warns) ||
    hasElements(msg.errors) || hasElements(msg.singleValidationErrors)) {
    // messageを出す
