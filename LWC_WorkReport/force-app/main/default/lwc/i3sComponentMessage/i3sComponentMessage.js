...
import { getMessage } from "c/i3sComponentSelectors";
import {
  clearErrors,
  clearWarns,
  clearInfos,
...
export default class I3sComponentMessage extends LightningElement {
  @api storeName;
  @track message;
  dialogTitle = CONSTANTS.DIALOG_TITLE;
  showInPage =
    CONSTANTS.DEFAULT_MESSAGE_MODE === CONSTANTS.MESSAGE_MODE.SHOW_IN_PAGE;
  showInToast =
    CONSTANTS.DEFAULT_MESSAGE_MODE === CONSTANTS.MESSAGE_MODE.SHOW_IN_TOAST;
  ...
  get showMessageInDialog() {
    return (
      CONSTANTS.DEFAULT_MESSAGE_MODE ===
        CONSTANTS.MESSAGE_MODE.SHOW_IN_DIALOG && this.hasMessages
    );
  }
