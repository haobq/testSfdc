...
import { clearCustomEvent } from 'c/alfaActions';
...
export function sendCustomEvent2Aura(event) {
  ...
  // send event to aura
  const auraEvent = new CustomEvent('auraevent', {detail: {eventType, eventName, params}});
  // dispatches the event.
  this.dispatchEvent(auraEvent);
}

export default class AlfaCustomEvent extends LightningElement {
  @api storeName;
  eventName;
